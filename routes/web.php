...
Route::namespace('App\Http\Controllers')->group(function(){
    ...
    Route::namespace('SuperAdmin\Announcement')->prefix('super-announcement')->group(function(){
        Route::get('/announcement', 'IndexController@get_announcement');
    });

    // notification
    Route::namespace('Notification')->prefix('notification')->group(function(){
        Route::get('/', 'IndexController@pendingNotify');
    });



    // iAccess Approve
    Route::namespace('iAccess\User\Form')->prefix('iaccess-approve')->group(function(){
    ...
    Route::middleware('auth')->group(function(){
        ...
        Route::middleware(['can:superadmin'])->namespace('SuperAdmin')->prefix('super_admin')->group(function(){
            ...
            Route::namespace('Register')->prefix('register')->group(function(){
                ...
                Route::get('/manager_mails/{login}', 'IndexController@manager_mails');
                Route::get('/register_mail_send/{login}', 'IndexController@register_mail_send');
            });
            ...
            Route::namespace('Operation')->prefix('operation')->group(function(){
                ...
                Route::prefix('offices')->group(function(){
                    ...
                    Route::get('/alloperations', 'OfficesController@alloperations');
                    Route::get('/alloffices', 'OfficesController@alloffices');
                    Route::get('/all_free_offices', 'OfficesController@all_free_offices');
        ...
        Route::namespace('CMS')->prefix('cms')->group(function(){
            ...
            Route::middleware(['can:cms'])->namespace('User')->group(function(){
                ...
                Route::prefix('app')->group(function(){
                    ...
                    Route::post('/feedback', 'ApplicationController@feedback');
        ...
        Route::namespace('Inventory')->prefix('inventory')->group(function(){
            ...
            Route::middleware(['can:inventory'])->namespace('Admin')->prefix('admin')->group(function(){
                ...
                Route::namespace('NewProduct')->prefix('new_product')->group(function(){
                    ...
                    Route::post('/deliver_multi', 'IndexController@deliver_multi');
                ...
                Route::namespace('OldProduct')->prefix('old_product')->group(function(){
                    ...
                    // options
                    Route::get('/options', 'IndexController@options');
                    Route::get('/locations', 'IndexController@locations');
                ...
                Route::namespace('Productsection')->prefix('product')->group(function(){
                    ...
                    Route::prefix('given_product')->group(function(){
                        Route::get('/index', 'IndexController@index');
                ...
                Route::namespace('Reportsection')->prefix('report')->group(function(){
                    ...
                    Route::prefix('stock2')->group(function(){
                        Route::get('/', 'StockController2@index');
                        Route::get('/export_data', 'StockController2@export_data');
                        Route::get('/export_view', 'StockController2@export_view');
                    });
        ...
        Route::namespace('iAccess')->prefix('iaccess')->group(function(){
            ...
            Route::middleware(['can:iAccessAdmin'])->namespace('Admin')->prefix('admin')->group(function(){
                ...
                Route::namespace('Verify')->prefix('verify')->group(function(){
