                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div>
                                                                <div style="margin: auto;padding: 1.4rem;background-color: white;border-radius: 8px;">
                                                                    ...
                                                                    Dear <b>Mr {{ $mailData['data']->manager->name }}</b>
                                                                    <br>
                                                                    <br>
                                                                    Here is an <b> Internet Access Request </b> on behlaf of <b> MR {{ $mailData->name }} <b>
                                                                    <br>,
                                                                    Position: <b> MR {{ $mailData->position }} <b>
                                                                    <br>,
                                                                    Branch: <b> MR {{ $mailData->branch }} <b>
                                                                    <br>,
                                                                    Department: <b> MR {{ $mailData->department }} <b>

                                                                    <br>
                                                                    <br>
                                                                    Request for : <b>{{ $mailData->request_for }}</b>  
                                                                    <br>
                                                                    <br>
                                                                    Request purpose : <b>{{ $mailData->purpose }}</b>
                                                                    <br>
                                                                    <br>
                                                                    @if ($mailData->web_url)
                                                                    Also Request for these websites : <b>{{ $mailData->web_url }}</b>
                                                                    <br>
                                                                    <br>
                                                                    @endif
                                                                    <div style="margin: 1rem 0;text-align:center;">
                                                                        <a href="{{ url('/iaccess/iwaccess/approve?token='). $mailData->manager_token }}" class="button_div" style="padding:0.7rem 1.8rem;background-color: #68c880;border-radius: 3px;color: white;text-decoration: none;">Approve</a>
                                                                    </div>
                                                                    <br>
                                                                    <br>
                                                                    or you can hold the application by simply ignore this mail
                                                                    <br>
                                                                    <br>
                                                                    Regards
