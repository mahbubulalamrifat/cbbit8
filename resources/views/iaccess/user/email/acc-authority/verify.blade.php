                                                                                        ...
                                                                                        <b>
                                                                                            ...
                                                                                            Department: <b>
                                                                                                ...
                                                                                                <b>
                                                                                                    ...
                                                                                                    <br>
                                                                                                    <br>
                                                                                                    Request for : <b> {{  $mailData['applicant_request_for'] }} </b>  
                                                                                                    <br>
                                                                                                    Access for : <b> {{  $mailData['applicant_access_for'] }} </b>  
                                                                                                    <br>
                                                                                                    <br>
                                                                                                    Request modules : <b>{{ $mailData['applicant_modules'] }}</b>
                                                                                                    <br>
                                                                                                    Request purpose : <b>{{ $mailData['applicant_purpose'] }}</b>
                                                                                                    <br>
                                                                                                    <br>
