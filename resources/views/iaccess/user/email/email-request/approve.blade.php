                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div>
                                                                <div style="margin: auto;padding: 1.4rem;background-color: white;border-radius: 8px;">
                                                                    ...
                                                                    <br>
                                                                    Request email : <b> {{  $mailData['applicant_request_email'] }} </b>    
                                                                    <br>
                                                                    <br>
                                                                    Request purpose : <b>{{ $mailData['applicant_purpose'] }}</b>
                                                                    <br>
                                                                    <br>
                                                                    @if ($mailData['applicant_web_url'])
                                                                    Also Request for these websites : <b>{{ $mailData['applicant_web_url'] }}</b>
                                                                    <br>
                                                                    <br>
                                                                    @endif
                                                                    ...
                                                                    <div style="margin: 1rem 0;text-align:center;">
                                                                        <span>
                                                                            <a href="{{ url('/iaccess-approve/email_request?token='). $mailData['token'] }}" class="button_span" style="padding:0.7rem 1.8rem;background-color: #68c880;border-radius: 3px;color: white;text-decoration: none;">Approve</a>
                                                                        </span>
                                                                        <span>
                                                                            <a href="{{ url('/iaccess-reject/email_request?token='). $mailData['token'] }}" class="button_span" style="padding:0.7rem 1.8rem;background-color: #801717;border-radius: 3px;color: white;text-decoration: none;">Reject</a>
                                                                        </span>
                                                                    </div>
