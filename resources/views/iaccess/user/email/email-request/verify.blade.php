                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div>
                                                                <div style="margin: auto;padding: 1.4rem;background-color: white;border-radius: 8px;">
                                                                    ...
                                                                    <br>
                                                                    <br>
                                                                    We have an <b> Access Request </b> on behlaf of
                                                                    <b> {{ $mailData['applicant_name'] }} </b>
                                                                    <br>
                                                                    <b> Position: </b>{{ $mailData['applicant_position'] }}
                                                                    <br>
                                                                    <b>Branch:</b>{{ $mailData['applicant_branch'] }}
                                                                    <br>
                                                                    <b>Department: </b>{{ $mailData['applicant_department'] }}
                                                                    <br>
                                                                    <br>
