                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:2px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div>
                                                                <div style="text-align:center;">
                                                                    <img src="https://asset.cpbangladesh.com/documents/cpbit_96_96_20220130055505qOomPLPI0l.png"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div>
                                                                <div
                                                                    style="margin: auto;padding: 1.4rem;background-color: white;border-radius: 8px;">


                                                                    Dear <b> {{ $mailData['applicant_name'] }},</b>

                                                                    <br>
                                                                    <br>
                                                                    We have an <b> Access Request </b> on behlaf of <b>
                                                                        {{ $mailData['applicant_name'] }} <b>
                                                                            ,<br>
                                                                            Position: <b>
                                                                                {{ $mailData['applicant_position'] }}
                                                                                <b>
                                                                                    ,<br>
                                                                                    Branch: <b>
                                                                                        {{ $mailData['applicant_branch'] }}
                                                                                        <b>
                                                                                            ,<br>
                                                                                            Department: <b>
                                                                                                {{ $mailData['applicant_department'] }}
                                                                                                <b>

                                                                                                    <br>
                                                                                                        <br>
                                                                                                        Guest User Company : <b> {{  $mailData['applicant_guest_company'] }} </b>
                                                                                                        <br>
                                                                                                        No of Guest User : <b> {{  $mailData['applicant_no_of_guest'] }} </b>
                                                                                                        <br>
                                                                                                        Guest User Job : <b> {{  $mailData['applicant_guest_job'] }} </b>
                                                                                                        <br>
                                                                                                        Guest User Duration : <b> {{  $mailData['applicant_guest_duration'] }} </b>
                                                                                                        <br>
                                                                                                        Start Date : <b> {{  $mailData['applicant_start_date'] }} </b>
                                                                                                        <br>
                                                                                                        End Date : <b> {{  $mailData['applicant_end_date'] }} </b>
                                                                                                        <br>
                                                                                                        <br>
                                                                                                    @if($mailData['verify_status'] == 1)
                                                                                                        <div
                                                                                                            style="margin: 1rem 0;text-align:center;">
                                                                                                            <p class="button_div"
                                                                                                                style="padding:0.7rem 1.8rem;background-color: #68c880;border-radius: 3px;color: white;text-decoration: none;">
                                                                                                                Accepted</p>
                                                                                                        </div>
                                                                                                    @elseif($mailData['verify_status']== 2)
                                                                                                        <div
                                                                                                            style="margin: 1rem 0;text-align:center;">
                                                                                                            <p class="button_div"
                                                                                                                style="padding:0.7rem 1.8rem;background-color: #d34634;border-radius: 3px;color: white;text-decoration: none;">
                                                                                                                Rejected</p>
                                                                                                        </div>
                                                                                                    @endif
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div>
                                                                <div
                                                                    style="text-align:center;color:#999999;align-items:center;font-size:12px;">
                                                                    <strong>
                                                                        <a href="https://www.cpbangladesh.com"
                                                                            style="text-decoration:none; color:#999999">CP
                                                                            Bangladesh</a>
                                                                    </strong>
                                                                    <div style="color: #999999">Holding No: E-236, Ward
                                                                        No: 07, Chandra,
