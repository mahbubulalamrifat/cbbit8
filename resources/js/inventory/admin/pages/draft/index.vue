                            ...
                            <tbody>
                                <tr v-for="singleData in allData.data" :key="singleData.id">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <v-btn @click="deleteDraft(singleData.id)" small color="error" elevation="10"
                                            class="mb-1">
                ...
                <v-card-text>
                    <v-form v-model="valid" ref="form">
                        <form @submit.prevent="editmode ? updateData() : createData()">
                            ...
                            <v-row>
                                <v-col cols="12">
                                    <v-text-field type="text" label="Draft Name:" :rules="nameRule" counter="50"
                                        v-model="form.name" outlined required>
                                    </v-text-field>
                                ...
                                <v-col cols="12">
                                    ...
                                    <v-textarea label="Details :" v-model="form.details" placeholder="Enter draft details" counter="2000" outlined
                                        required></v-textarea>
...
<script>
    ...
    import vue2EditorToolbar from "../../js/common/vue2_editor_toolbar"
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                //current page url
                currentUrl: '/inventory/admin/draft',
