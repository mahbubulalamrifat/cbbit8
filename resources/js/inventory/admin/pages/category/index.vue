  ...
  <div>
    <v-card>
      <v-card-title class="justify-center">
        <v-row>
          <v-col cols="10"> All Inventory Category List </v-col>
          <v-col cols="2">
            <v-btn
              @click="addDataModel()"
              color="primary"
            ...
            <table class="table table-bordered text-center">
              <thead>
                <tr>
                  ...
                  <th>
                    ...
                    <span
                      v-if="sort_direction == 'desc' && sort_field == 'stock'"
                      >&uarr;</span
                    >
                    <span
                      v-if="sort_direction == 'asc' && sort_field == 'stock'"
                      >&darr;</span
                    >
                  </th>
                  <th>
              ...
              <tbody>
                <tr v-for="singleData in allData.data" :key="singleData.id">
                  ...
                  <td>
                    <span v-if="singleData.stock == 'y'" class="text-success"
                      >Stockable</span
                    >
            ...
            <form @submit.prevent="editmode ? updateData() : createData()">
              <v-row align-content="center">
                ...
                <v-col md="12">
                  <v-checkbox
                    v-model="form.stock"
                    label="Is That Stockable Category"
                    color="indigo"
                    value="y"
                    hide-details
                  ></v-checkbox>
