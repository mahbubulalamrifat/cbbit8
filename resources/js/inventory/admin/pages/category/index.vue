                        ...
                        <table class="table table-bordered text-center">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <a href="#" @click.prevent="change_sort('stock')">Stock</a>
                                        <span v-if="sort_direction == 'desc' && sort_field == 'stock'">&uarr;</span>
                                        <span v-if="sort_direction == 'asc' && sort_field == 'stock'">&darr;</span>
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                <tr v-for="singleData in allData.data" :key="singleData.id">
                                    ...
                                    <td>
                                        <span v-if="singleData.stock == 'y'" class="text-success">Stockable</span>
                                         <span v-else class="text-danger">Non Stockable</span>
                                    </td>
                                    <td><span
                    ...
                    <v-form v-model="valid" ref="form">
                        <form @submit.prevent="editmode ? updateData() : createData()">
                            ...
                            <v-row align-content="center">
                                <v-col md="12">
                                    <v-text-field v-model="form.name" label="Enter Category Name" :rules="reqRules"
                                       counter="500" required></v-text-field>
                                    <div class="text-danger" v-if="form.errors.has('name')"
                                        v-html="form.errors.get('name')" />
                                </v-col>
                                <v-col md="12">
                                    <v-checkbox v-model="form.stock" label="Is That Stockable Category" color="indigo" value="y"
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                //current page url
                currentUrl: '/inventory/admin/category',
