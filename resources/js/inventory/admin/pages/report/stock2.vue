                    ...
                    <table class="table table-bordered text-center">
                        ...
                        <tbody>
                            <tr v-for="singleData in allData.data" :key="singleData.id">
                                ...
                                <td><span v-if="singleData.newold && singleData.newold.location">{{ singleData.newold.location }}</span><span v-else class="error--text">N/A</span></td>

                                <td><span v-if="singleData.newold && singleData.newold.department">{{ singleData.newold.department }}</span><span v-else class="error--text">N/A</span></td>
    ...
    export default {
        ...
        methods: {
            ...
            getResults(page = 1) {
                ...
                axios.get(this.currentUrl + '/stock2?page=' + page +
            ...
            exportExcel() {
                ...
                axios({
                    method: 'get',
                    url: this.currentUrl + '/stock2/export_data?sort_by_startDate=' + this.sort_by_startDate +
                    '&sort_by_endDate=' + this.sort_by_endDate +
                    '&sort_by_category=' + this.current_category.id +
