    ...
    <div>
        <v-card>
            ...
            <v-card-text>
                ...
                <h2 class="error--text text-center" v-if="!totalValue && !dataLoading" >New Deleted Product Data Not Available <v-icon large color="error">mdi-alert-octagon-outline</v-icon></h2>
