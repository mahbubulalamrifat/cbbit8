<template>
  <div>
    <v-card>
      <v-card-title> All New Product Deleted Data </v-card-title>
      ...
      <v-card-text>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr v-for="singleData in allData.data" :key="singleData.id">
                  <td>
                    <div><b>Product Name: </b>{{ singleData.name }}</div>
                    <div>
                    ...
                    <div><b>Product Serial: </b>{{ singleData.serial }}</div>
                  </td>
                  ...
                  <td class="text-center">
                    <v-btn
                      class="ma-2"
                      @click="deleteData(singleData.id, 'new')"
                      color="error"
                      elevation="20"
                      small
                    >
                    ...
                    <v-btn
                      class="ma-2"
                      @click="restoreData(singleData.id, 'new')"
                      color="success"
                      elevation="20"
                      small
                    >
        ...
        <h4 v-if="!totalValue && !dataLoading" class="text-center">
          ...
          >
            New Deleted Product Data Not Available
          </div>
        </h4>
      </v-card-text>
    </v-card>
...
export default {
  ...
  methods: {
    ...
    getAllCategory() {
      axios
        .get("/inventory/admin/category/all")
        .then((response) => {
