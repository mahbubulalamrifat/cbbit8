<template>
  <div>
    <v-card>
      <v-card-title> All Old Product Deleted Data </v-card-title>
      ...
      <v-card-text>
              ...
              <tbody>
                <tr v-for="singleData in allData.data" :key="singleData.id">
                  ...
                  <td class="text-center">
                    <v-btn
                      class="ma-2"
                      @click="deleteData(singleData.id, 'old')"
                      color="error"
                      elevation="20"
                      small
                    >
                    ...
                    <v-btn
                      class="ma-2"
                      @click="restoreData(singleData.id, 'old')"
                      color="success"
                      elevation="20"
                      small
                    >
        ...
        <h4 v-if="!totalValue && !dataLoading" class="text-center">
          ...
          >
            Old Deleted Product Data Not Available
          </div>
        </h4>
      </v-card-text>
    </v-card>
