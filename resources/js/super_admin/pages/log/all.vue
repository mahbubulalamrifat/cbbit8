              ...
              <thead class="text-center">
                <tr>
                  ...
                  <th>
                    ...
                    <span
                      v-if="
                        sort_direction == 'desc' && sort_field == 'login_id'
                      "
                      >&uarr;</span
                    >
                    <span
                  ...
                  <th>
                    ...
                    <span v-if="sort_direction == 'desc' && sort_field == 'ip'"
                      >&uarr;</span
                    >
                    <span v-if="sort_direction == 'asc' && sort_field == 'ip'"
                      >&darr;</span
                    >
                  </th>
                  <th>
                  ...
                  <th>
                    <a href="#" @click.prevent="change_sort('device')"
                      >Device</a
                    >
                    <span
                    ...
                    >
                    <span
                      v-if="sort_direction == 'asc' && sort_field == 'device'"
                      >&darr;</span
                    >
                  </th>
                  <th>
              ...
              <tbody>
                <tr v-for="singleData in allData.data" :key="singleData.id">
                  ...
                  <td>
                    ...
                    >
                    <span v-if="singleData.status == 0" class="text-danger"
                      >Not authorized CPB-IT</span
                    >
                    <span v-if="singleData.status == 2" class="text-danger"
                      >User blocked</span
                    >
                  </td>
                  ...
                  <td>
                    <span
                      v-if="singleData.updated_at != singleData.created_at"
                      >{{
