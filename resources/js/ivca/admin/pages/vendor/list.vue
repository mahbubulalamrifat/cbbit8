            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th>Action</th>
                  <th>
                    <a href="#" @click.prevent="change_sort('vendor_number')"
                      >Vendor number</a
                    >
                    <span
                      v-if="
                        sort_direction == 'desc' &&
                        sort_field == 'Vendor Number'
                      "
                      >&uarr;</span
                    >
                    <span
                      v-if="
                        sort_direction == 'asc' && sort_field == 'vendor_number'
                      "
                      >&darr;</span
                    >
                  </th>
                  <th>
                    <a href="#" @click.prevent="change_sort('suppier_name')"
                      >Vendor Name</a
                    >
                    <span
                      v-if="
                        sort_direction == 'desc' && sort_field == 'suppier_name'
                      "
                      >&uarr;</span
                    >
                    <span
                      v-if="
                        sort_direction == 'asc' && sort_field == 'suppier_name'
                      "
                      >&darr;</span
                    >
                  </th>
                  <th>
                    ...
                    >
                    <span
                      v-if="sort_direction == 'desc' && sort_field == 'address'"
                      >&uarr;</span
                    >
                    <span
                      v-if="sort_direction == 'asc' && sort_field == 'address'"
                      >&darr;</span
                    >
                  </th>
                  <th>
                    ...
                    <span
                      v-if="
                        sort_direction == 'desc' && sort_field == 'contact_name'
                      "
                      >&uarr;</span
                    >
                    <span
                      v-if="
                        sort_direction == 'asc' && sort_field == 'contact_name'
                      "
                      >&darr;</span
                    >
                  </th>
                  <th>
                    ...
                    <span
                      v-if="sort_direction == 'desc' && sort_field == 'email'"
                      >&uarr;</span
                    >
                    <span
                      v-if="sort_direction == 'asc' && sort_field == 'email'"
                      >&darr;</span
                    >
                  </th>
                  <th>
                    <a href="#" @click.prevent="change_sort('telephone')"
                      >Telephone</a
                    >
                    <span
                      v-if="
                        sort_direction == 'desc' && sort_field == 'telephone'
                      "
                      >&uarr;</span
                    >
                    <span
                      v-if="
                        sort_direction == 'asc' && sort_field == 'telephone'
                      "
                      >&darr;</span
                    >
                  </th>
                  <th>
                    <a href="#" @click.prevent="change_sort('blocked')"
                      >Status</a
                    >
                    <span
                      v-if="sort_direction == 'desc' && sort_field == 'blocked'"
                      >&uarr;</span
                    >
                    <span
                      v-if="sort_direction == 'asc' && sort_field == 'blocked'"
                      >&darr;</span
                    >
                  </th>
                </tr>
              ...
              <tbody>
                <tr v-for="singleData in allData.data" :key="singleData.id">
                  ...
                  <td>
                    <span v-if="singleData.blocked == 1" class="text-danger"
                      >Blocked</span
                    >
          ...
          <v-form v-model="valid">
            <form @submit.prevent="editmode ? updateData() : createData()">
              <v-text-field
                ...
                :rules="[(v) => !!v || 'Vendor Number is required!']"
                required
                :readonly="editmode"
              >
              </v-text-field>
              <div
                ...
                v-if="form.errors.has('vendor_number')"
                v-html="form.errors.get('vendor_number')"
              />

              <v-text-field
                v-model="form.suppier_name"
              ...
              <div
                class="small text-danger"
                v-if="form.errors.has('suppier_name')"
              ...
              <v-textarea
                ...
                :rules="[(v) => !!v || 'Vendor Address is required!']"
                required
              >
              </v-textarea>
              <div
              ...
              <v-text-field
                ...
                :rules="[(v) => !!v || 'Telephone / Contact is required!']"
                required
              >
              </v-text-field>
              <div
