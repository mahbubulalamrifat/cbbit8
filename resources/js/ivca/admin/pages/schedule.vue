          ...
          <b-form-group label="Vendor List:">
            <b-form-select v-model="form.vendor_id" size="sm">
              <b-form-select-option value=""
                >Please select a vendor</b-form-select-option
              >
              <b-form-select-option
                ...
                :value="vendor.id"
              >
                {{ vendor.vendor_number }} || {{ vendor.suppier_name }} ||
                {{ vendor.contact_name }}
              </b-form-select-option>
            </b-form-select>
            <div
          ...
          <b-col>
            <b-form-group label="User List:">
              <b-form-select v-model="form.user_id" size="sm">
                <b-form-select-option value=""
                  >Please select auditor</b-form-select-option
                >
                <b-form-select-option
          ...
          <b-col>
            <b-form-group label="Remarks:">
              <b-form-textarea
                ...
                placeholder="Enter audit schedule remarks"
                rows="2"
