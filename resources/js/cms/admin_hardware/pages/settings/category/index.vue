  ...
  <div>
    <v-card>
      <v-card-title class="justify-center">
        <v-row>
          <v-col cols="10"> All Category List </v-col>
          <v-col cols="2">
            <v-btn
              @click="addDataModel()"
              elevation="20"
              ...
              <thead>
                <tr>
                  ...
                  <th>
                    ...
                    <span
                      v-if="sort_direction == 'desc' && sort_field == 'label'"
                      >&uarr;</span
                    >
                    <span
                      v-if="sort_direction == 'asc' && sort_field == 'label'"
                      >&darr;</span
                    >
                  </th>
                  <th>Accessories</th>
                ...
                <tr v-for="singleData in allData.data" :key="singleData.id">
                  ...
                  <td>
                    <span v-if="singleData.acsosoris.length">
                      <span
                        v-for="(item, index) in singleData.acsosoris"
                        :key="index"
                      >
          ...
          >
            ...
            <v-row align-content="center">
              ...
              <v-col md="12">
                <v-text-field
                  v-model="form.label"
                  label="Dependent label Name"
                  :rules="namRules"
                  counter="100"
                  placeholder="Enter category dependent label Name"
                ></v-text-field>
                <div
                  class="text-danger"
  ...
  methods: {
    ...
    async updateData() {
      ...
      const response = await this.form.put(
        this.currentUrl + "/update/" + this.form.id
      );
      // Input field make empty
      this.form.reset();
      this.$refs.form.resetValidation();
