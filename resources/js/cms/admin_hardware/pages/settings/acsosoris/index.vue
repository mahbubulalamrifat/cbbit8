        ...
        <v-card>
            <v-card-title class="justify-center">
                <v-row>
                    ...
                    <v-col cols="2">
                        <v-btn @click="addDataModel()" elevation="20" color="primary" small outlined
                            class="float-right">
                    ...
                    <v-form v-model="valid" ref="form">
                        <form @submit.prevent="editmode ? updateData() : createData()">
                            ...
                            <v-row align-content="center">
                                <v-col md="12">
                                    <v-text-field v-model="form.name" label="Enter Acsosoris Name" :rules="namRules"
                                        counter="100" placeholder="Enter Acsosoris Name" required></v-text-field>
