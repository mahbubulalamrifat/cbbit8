  ...
  <div>
    <v-card>
      <v-card-title class="justify-center">
        <v-row>
          <v-col cols="10"> All Category Name </v-col>
          <v-col cols="2">
            <v-btn
              @click="addDataModel()"
              color="primary"
          ...
          <table class="table table-bordered text-center">
            <thead>
              ...
              <th>
                ...
                <span v-if="sort_direction == 'desc' && sort_field == 'label'"
                  >&uarr;</span
                >
                <span v-if="sort_direction == 'asc' && sort_field == 'label'"
                  >&darr;</span
                >
              </th>
              <th>
              ...
              <tr v-for="singleData in allData.data" :key="singleData.id">
                ...
                <td>
                  <span v-if="singleData.dependences.length">
                    <span
                      v-for="(item, index) in singleData.dependences"
                      :key="index"
                    >
                ...
                <td>
                  ...
                  <span v-else
                    ><span class="error--text"> Not Found </span></span
                  >
                </td>
              </tr>
            </tbody>
