  ...
  <div>
    <v-card>
      <v-card-title class="justify-center">
        <v-row>
          <v-col cols="8" lg="10"> All Damaged Complain Reports </v-col>
          <v-col cols="4" lg="2">
            <v-btn
              outlined
              elevation="5"
            ...
            <table class="table table-bordered">
              <thead class="text-center">
                <tr>
                  ...
                  <th>Subcategory</th>
                  <th>
                    <a href="#" @click.prevent="change_sort('damaged_reason')"
                      >Reason</a
                    >
                    <span
                      v-if="
                        sort_direction == 'desc' &&
                        sort_field == 'damaged_reason'
                      "
                      >&uarr;</span
                    >
                    <span
              ...
              <tbody class="text-center">
                <tr v-for="singleData in allData.data" :key="singleData.id">
                  ...
                  <td>
                    <span v-if="singleData.complain.created_at">{{
                      singleData.complain.created_at | moment("MMM Do YYYY")
                    }}</span>
                  </td>
                  <td>
                    <span v-if="singleData.updated_at">{{
                      singleData.updated_at | moment("MMM Do YYYY")
                    }}</span>
                  </td>
                  <td class="text-center">
                    <v-btn
