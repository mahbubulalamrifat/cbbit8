<template>
  <div>
    <v-card>
      <v-card-title> All Delivered Complain List </v-card-title>
      ...
      <v-card-text class="pt-3">
            ...
            <table class="table table-bordered text-center">
              <thead>
                <tr>
                  <th>Num.</th>
                  <th>
                    <a href="#" @click.prevent="change_sort('rec_name')"
                      >Rec. Name</a
                    >
                    <span
                      v-if="
                        sort_direction == 'desc' && sort_field == 'rec_name'
                      "
                      >&uarr;</span
                    >
                    <span
                      v-if="sort_direction == 'asc' && sort_field == 'rec_name'"
                      >&darr;</span
                    >
                  </th>
                  <th>
                    <a href="#" @click.prevent="change_sort('rec_contact')"
                      >Rec. Contact</a
                    >
                    <span
                      v-if="
                        sort_direction == 'desc' && sort_field == 'rec_contact'
                      "
                      >&uarr;</span
                    >
                    <span
                      v-if="
                        sort_direction == 'asc' && sort_field == 'rec_contact'
                      "
                      >&darr;</span
                    >
                  </th>
                  <th>
                    <a href="#" @click.prevent="change_sort('rec_position')"
                      >Rec. Position.</a
                    >
                    <span
                      v-if="
                        sort_direction == 'desc' && sort_field == 'rec_position'
                      "
                      >&uarr;</span
                    >
                    <span
                      v-if="
                        sort_direction == 'asc' && sort_field == 'rec_position'
                      "
                      >&darr;</span
                    >
                  </th>
              ...
              <tbody>
                <tr v-for="singleData in allData.data" :key="singleData.id">
                  ...
                  <td>
                    <span v-if="singleData.complain.makby">{{
                      singleData.complain.makby.department
                    }}</span>
                  </td>
                  <td>
                    <span v-if="singleData.makby">{{
                      singleData.makby.business_unit
                    }}</span>
                  </td>
                  <td>
                    <v-btn
                      @click="action(singleData.complain.id)"
                      color="error"
                      depressed
                      small
                      elevation="20"
        ...
        <h4 v-if="!totalValue && !dataLoading" class="text-center">
          ...
          >
            Not have any delivered Complaint
          </div>
        </h4>
      </v-card-text>
    </v-card>
