<template>
  <div>
    <v-card>
      <v-card-title> H.O. Service Complain List </v-card-title>
      ...
      <v-card-text>
        <v-row>
          ...
          <v-col cols="9" lg="4">
            ...
            <v-select
              v-if="isHardwareHoService()"
              v-model="zone_office_custom"
              label="Zones:"
        ...
        <h4 v-if="!totalValue && !dataLoading" class="text-center">
          ...
          >
            Not have any head office service Complaint
          </div>
        </h4>
      </v-card-text>
    </v-card>
