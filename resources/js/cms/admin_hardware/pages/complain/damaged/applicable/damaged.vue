<template>
  <div>
    <v-card>
      <v-card-title> All Applicable Damaged Complain List </v-card-title>
      ...
      <v-card-text>
            ...
            <table class="table table-bordered text-center">
              <thead>
                <tr>
                  ...
                  <th>
                    <a href="#" @click.prevent="change_sort('apply_at')"
                      >Applied</a
                    >
                    <span
                      v-if="
                        sort_direction == 'desc' && sort_field == 'apply_at'
                      "
                      >&uarr;</span
                    >
                    <span
                      v-if="sort_direction == 'asc' && sort_field == 'apply_at'"
                      >&darr;</span
                    >
                  </th>
                  <th>Category</th>
              ...
              <tbody>
                <tr v-for="singleData in allData.data" :key="singleData.id">
                  ...
                  <td>
                    <span
                      v-if="
                        singleData.dam_apply && singleData.dam_apply.apply_at
                      "
                      >{{
                        singleData.dam_apply.apply_at | moment("MMMM Do YYYY")
                      }}</span
                    >
                  ...
                  <td>
                    <v-btn
                      v-if="singleData.dam_apply.apply_quotation"
                      @click="action(singleData.id)"
                      color="success"
                      depressed
                      small
                      elevation="20"
        ...
        <h4 v-if="!totalValue && !dataLoading" class="text-center">
          ...
          >
            Not have any damaged Complaint
          </div>
        </h4>
      </v-card-text>
    </v-card>
