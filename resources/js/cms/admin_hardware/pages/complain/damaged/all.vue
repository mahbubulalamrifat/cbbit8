                ...
                <tr v-for="singleData in allData.data" :key="singleData.id">
                  ...
                  <td>
                    <span v-if="singleData.dam_apply">{{
                      singleData.dam_apply.damaged_reason
                    }}</span>
                  </td>
                  <td>
                    <span v-if="singleData.dam_apply">
                      <span
                        v-if="
                          singleData.dam_apply.applicable_type == 'Applicable'
                        "
                        >{{ singleData.dam_apply.applicable_type }}
                        <br />
                        <span
                          class="text-muted small"
                          v-if="singleData.dam_apply.apply_at"
                          >Applied
                          {{
                            singleData.dam_apply.apply_at
                              | moment("MMM Do YYYY")
                          }}</span
                        >
                      ...
                      <span v-else>
                        ...
                        ><span v-else class="text-danger">N/A</span></span
                      >
                    </span>
                  </td>
                  <td>
                  ...
                  <td>
                    <v-btn
                      v-if="
                        singleData.dam_apply &&
                        singleData.dam_apply.apply_quotation
                      "
