            ...
            <v-card-text>
                        ...
                        <table class="table table-bordered text-center">
                            <thead>
                                <tr>
                                    ...
                                    <th>Business Unit</th>
                                    <th>
                                        <a href="#" @click.prevent="change_sort('created_at')">Register At</a>
                                        <span
                                            v-if="sort_direction == 'desc' && sort_field == 'created_at'">&uarr;</span>
                                        <span v-if="sort_direction == 'asc' && sort_field == 'created_at'">&darr;</span>
                                    </th>
                                    <th>
                                        <a href="#" @click.prevent="change_sort('updated_at')">Closed At</a>
                                        <span
                                            v-if="sort_direction == 'desc' && sort_field == 'updated_at'">&uarr;</span>
                            ...
                            <tbody>
                                <tr v-for="singleData in allData.data" :key="singleData.id">
                                    ...
                                    <td>
                                        <v-btn @click="action(singleData.id)" color="error" depressed small
                                            elevation="20">
                ...
                <div v-else>
                    <div v-if="dataLoading" class="p-5 my-5">
                        <p class="text-center h1">Loading.. <v-icon color="success" size="100">mdi-loading mdi-spin
                            </v-icon>
                        </p>
                    </div>
                </div>
                <h1 v-if="!totalValue && !dataLoading" class="text-danger text-center">Not have any closed Complaint
