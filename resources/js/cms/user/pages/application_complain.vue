                        ...
                        <v-row align-content="center" class="pt-5">
                            <v-col cols="12" lg="6">
                                ...
                                <v-autocomplete :items="allCategory" @change="getSubcategory
                                    ()" v-model="form.cat_id" label="Select Software"
                                    :rules="[v => !!v || 'Software is required!']" outlined required></v-autocomplete>
                            </v-col>
                            <v-col cols="12" lg="6">
                                ...
                                <v-autocomplete :items="allSubcategory" v-model="form.subcat_id"
                                    label="Select Software Module" :rules="[v => !!v || 'Software Module is required!']"
                            ...
                            <v-col lg="3" md="6" cols="12">
                                <v-file-input @change="uploadDocByName($event, 'document2')" show-size
                                    label="Document 2" accept="image/*, .pdf, .xlsx, .docx" :rules="docRules" outlined>
                                </v-file-input>
                            </v-col>
                            <v-col lg="3" md="6" cols="12">
                                <v-file-input @change="uploadDocByName($event, 'document3')" show-size
                                    label="Document 3" accept="image/*, .pdf, .xlsx, .docx" :rules="docRules" outlined>
                                </v-file-input>
                            </v-col>
                            <v-col lg="3" md="6" cols="12">
                                <v-file-input @change="uploadDocByName($event, 'document4')" show-size
                                    label="Document 4" accept="image/*, .pdf, .xlsx, .docx" :rules="docRules" outlined>
                                </v-file-input>
                            </v-col>
                        </v-row>
