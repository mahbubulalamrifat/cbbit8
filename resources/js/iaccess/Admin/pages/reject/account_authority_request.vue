            ...
            <v-card-text>
              <v-row>
                  ...
                  <v-row>
                    ...
                    <v-col cols="12" lg="6">
                      <div>
                        ...
                        <span
                          v-if="
                            item.document || item.document2 || item.document3
                          "
                        >
                          ...
                          <span v-if="item.document3">
                            ...
                            >
                              <v-btn
                                ...
                                color="success"
                              >
                                <v-icon left>mdi-eye</v-icon>DOC (PDF)
                              </v-btn>
                            </span>
                            <span
                              v-else-if="
                                (item.document3 &&
                                  item.document3.includes('.jpg')) ||
                                (item.document3 &&
                                  item.document3.includes('.jpeg')) ||
                                (item.document3 &&
                                  item.document3.includes('.png')) ||
                                (item.document3 &&
                                  item.document3.includes('.JPG')) ||
                                (item.document3 &&
                                  item.document3.includes('.JPEG')) ||
                ...
                <v-col cols="12" lg="3">
                  ...
                  <div><b>Access For:</b> {{ item.access_for }}</div>
                  <div>
                    <b>Purpose:</b>
                ...
                <v-col cols="12" lg="4">
                  ...
                  <div>
                    ...
                    <div v-if="item.manager_approved">
                      ...
                      <div
                        v-else-if="item.bu_rejected || item.manager_rejected"
                      >
                        <span class="error rounded-pill h6 text-white px-2">
                          <v-icon left small color="white"
                            >mdi-close-octagon</v-icon
...
export default {
  ...
  data() {
    return {
      ...
      //current page url
      currentUrl: "/iaccess/admin/reject/account_authority",
