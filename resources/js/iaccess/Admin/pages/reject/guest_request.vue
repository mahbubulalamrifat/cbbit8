<template>
  <div>
    <v-card>
      <v-card-title> Guest Request List </v-card-title>
          ...
          <v-card v-for="item in allData.data" :key="item.id" class="mb-3">
            <v-card-text>
              <v-row>
                ...
                <v-col cols="12" lg="3">
                  <div>
                    <b>Guest User Company:</b>
                    <span v-if="item.guest_company">{{
                      item.guest_company
                    }}</span>
                  ...
                  <div>
                    <b>No of Guest:</b>
                    <span v-if="item.no_of_guest">{{ item.no_of_guest }}</span>
                  ...
                  <div>
                    <b>Guest User Job:</b>
                    <span v-if="item.guest_job">{{ item.guest_job }}</span>

                    <span v-else class="error--text">N/A</span>
                  </div>

                  <div>
                    <b>Guest User Duration:</b>
                    <span v-if="item.guest_duration">{{
                      item.guest_duration
                    }}</span>
...
export default {
  ...
  data() {
    return {
      ...
      //current page url
      currentUrl: "/iaccess/admin/reject/guest_request",
