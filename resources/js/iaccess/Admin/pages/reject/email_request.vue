<template>
  <div>
    <v-card>
      <v-card-title> Email Request List </v-card-title>
              ...
              <v-row>
                <v-col cols="12" lg="5">
                  <v-row>
                    ...
                    <v-col cols="12" lg="6">
                      <div>
                        <b>Personal Mobile:</b> {{ item.personal_mobile }}
...
export default {
  ...
  data() {
    return {
      ...
      //current page url
      currentUrl: "/iaccess/admin/reject/email_request",
