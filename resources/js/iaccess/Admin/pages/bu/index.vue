            ...
            <table class="table table-bordered">
              <thead class="text-center">
                <tr>
                  ...
                  <th>
                    <a href="#" @click.prevent="change_sort('designation')"
                      >Designation</a
                    >
                    <span
                      v-if="
                        sort_direction == 'desc' && sort_field == 'designation'
                      "
                      >&uarr;</span
                    >
                    <span
                      v-if="
                        sort_direction == 'asc' && sort_field == 'designation'
                      "
                      >&darr;</span
                    >
                  </th>
            ...
            <form @submit.prevent="editmode ? updateData() : createData()">
              <v-row>
                ...
                <v-col cols="12">
                  <v-text-field
                    type="designation"
                    label="B.U. designation:"
                    placeholder="Enter B.U. designation"
                    counter="100"
                  ...
                  <div
                    class="text-danger"
                    v-if="form.errors.has('designation')"
