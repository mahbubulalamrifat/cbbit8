  ...
  <v-dialog v-model="dataModalDialog">
          ...
          <form @submit.prevent="createData()">
            ...
            <v-row class="mt-2">
              ...
              <v-col cols="12" lg="4">
                ...
                <v-autocomplete
                  label="Branch:"
                  placeholder="Enter applicant branch"
                  v-model="form.branch"
                  required
              ...
              <v-col cols="12" lg="4">
                <div
                  class="text-danger"
                  v-if="form.errors.has('office_mobile')"
                  v-html="form.errors.get('office_mobile')"
                />
                <v-text-field
                  label="Office Mobile"
                  :rules="numberRules"
                  placeholder="Enter applicant office mobile"
              ...
              <v-col cols="12" lg="4">
                <div
                  class="text-danger"
                  v-if="form.errors.has('personal_mobile')"
                  v-html="form.errors.get('personal_mobile')"
                />
                <v-text-field
                  label="Personal Mobile"
                  placeholder="Enter applicant personal mobile"
              ...
              <v-col cols="12" lg="4">
                ...
                <v-text-field
                  ...
                  placeholder="Enter applicant personal e-mail"
              ...
              <v-col cols="12" lg="4">
                ...
                <v-text-field
                  label="Office e-mail"
                  :rules="emailRules"
                  placeholder="Enter applicant office e-mail"
              ...
              <v-col cols="12" lg="4">
                <div
                  class="text-danger"
                  v-if="form.errors.has('document3')"
                  v-html="form.errors.get('document3')"
                />
                <v-file-input
                  prepend-icon="mdi-paperclip"
                  @change="uploadDocumentByName($event, 'document3')"
            ...
            <div>
              Do you have any ID <b>(like xxxx.yyy)</b> for Smart Soft, Smart
              Procurement, Win Feed, Win Farm or other
              <p v-if="int_id == 'n'" class="text-danger">
                For first time user must attach National & CP ID card's
                photocopy with user & users thai superior signature. User must
                fill up the form properly with also star (**) mark area
                otherwise canceled by CPB-IT without any notice.
              </p>
            </div>
            <v-row>
              <v-col lg="2" cols="6">
              ...
              <v-col lg="8" cols="12" v-if="int_id == 'y'">
                <v-text-field
                  label="Enter the ID"
                  placeholder="Enter AD ID like xxxx.yyy"
                  v-model="form.internet_id"
                  required
                ></v-text-field>
              </v-col>
            </v-row>
            ...
            <v-row>
              <div
                class="text-danger"
                v-if="form.errors.has('request_for')"
            ...
            <div class="h5 py-2 bg-dark text-white text-center mt-5" block>
              Access For
            </div>
            <v-row>
              <v-col
                lg="3"
                cols="6"
                v-for="(data, index) in accessOptions"
                :key="index"
                class="py-0"
              >
                <v-checkbox
                  multiple
                  v-model="form.access_for"
                  :label="data.text"
                  :value="data.value"
                  color="success"
                  hide-details
    ...
    <v-overlay :value="overlayshow" z-index="9999">
      <v-progress-circular indeterminate size="64"
        ><v-icon>mdi-email</v-icon></v-progress-circular
      >
    </v-overlay>
  </v-dialog>
</template>
