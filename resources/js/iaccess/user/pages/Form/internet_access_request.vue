                    ...
                    <form @submit.prevent="createData()">
                        ...
                        <v-row class="mt-2">
                            ...
                            <v-col cols="12" lg="4">
                                ...
                                <v-text-field label="Office e-mail" :rules="emailRules"
                                    placeholder="Enter applicant office e-mail" v-model="form.office_email" dense>
                                </v-text-field>
                            </v-col>
                        ...
                        <v-row>
                            ...
                            <v-col lg="3" cols="6" v-for="(data, index) in options" :key="index" required>
                        ...
                        <v-row>
                            <v-col cols="12" lg="6">
                                <div class="text-danger" v-if="form.errors.has('web_url')"
                                    v-html="form.errors.get('web_url')" />
                                <v-textarea label="Web Address (URL)" v-model="form.web_url" outlined dense>
                                </v-textarea>
                            </v-col>
                            <v-col cols="12" lg="6">
    ...
    export default {
        data() {
            return {
                ...
                currentUrl: '/iaccess/form/iwaccess',
