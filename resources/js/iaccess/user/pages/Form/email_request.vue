                ...
                <v-form v-model="valid" ref="form">
                    <form @submit.prevent="createData()">
                        ...
                        <v-row>
                            ...
                            <v-col lg="3" cols="6" v-for="(data, index) in options" :key="index" required class="py-0">
                                <v-checkbox multiple v-model="form.request_for" :label="data.text" :value="data.value"
                                    color="indigo" hide-details></v-checkbox>
                            </v-col>
                        </v-row>

                        <div class="h5 py-2 bg-dark text-white text-center mt-5" block>Request Email ID</div>
                        <v-text-field dense label="Request Email ID" class="mt-4" placeholder="Enter an Email @cpbangladesh.com" v-model="form.request_email" outlined></v-text-field>

                        <div class="h5 py-2 bg-dark text-white text-center mb-5" block>Purpose</div>
                        <v-row>
                            <v-col cols="12" lg="12">
    ...
    export default {
        data() {
            return {
                ...
                currentUrl: '/iaccess/form/email_request',
