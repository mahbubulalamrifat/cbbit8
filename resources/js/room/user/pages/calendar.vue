  ...
  <div class="container py-5">
      ...
      <v-card>
        <v-card-title class="justify-center">
          <v-row>
            ...
            <v-col cols="2">
              <v-btn
                @click="eventDataStoreModal = false"
                color="red lighten-1"
                small
                text
                class="float-right"
        ...
        <v-card-text>
          <div
            v-if="currentSelectedRoom"
            class="bg-info text-center rounded mb-2"
          >
            Selected Room: <b>{{ currentSelectedRoom.name }}</b
            >, Capacity:
    ...
    <v-dialog v-model="roomStatusShow" scrollable>
      <v-card>
        ...
        <v-card-title class="justify-center">
          <v-row>
            <v-col cols="10"> Select Room for Booking </v-col>
            <v-col cols="2">
              <v-btn
                @click="roomStatusShow = false"
                color="red lighten-1"
                small
                text
                class="float-right"
        ...
        <v-card-text>
          ...
          >
            <thead class="bg-success">
              <tr>
                <th colspan="3" class="text-center booking_table_border p-0">
              ...
              <tr v-for="singleData in bookings" :key="singleData.id">
                <td>
                  <span v-if="singleData.room">
                    <img
                      v-if="singleData.room.image"
                      :src="imagePathSm + singleData.room.image"
                      alt="image"
                      class="img-fluid"
                      height="50"
                      width="80"
                ...
                <td class="text-left">
                  ...
                  <b>Booked:</b>
                  {{ singleBookedTimeShow(singleData.start, singleData.end) }}
                  <br />
