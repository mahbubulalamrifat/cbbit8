            ...
            <table class="table table-bordered">
              <thead class="text-center">
                <tr>
                  ...
                  <th>
                    <a href="#" @click.prevent="change_sort('purpose')"
                      >Purpose</a
                    >
                    <span
                      v-if="sort_direction == 'desc' && sort_field == 'purpose'"
                      >&uarr;</span
                    >
                    <span
                      v-if="sort_direction == 'asc' && sort_field == 'purpose'"
                      >&darr;</span
                    >
                  </th>
                  <th>
              ...
              <tbody>
                <tr v-for="singleData in allData.data" :key="singleData.id">
                  ...
                  <td>
                    <span v-if="singleData.status == 1">Booked</span
