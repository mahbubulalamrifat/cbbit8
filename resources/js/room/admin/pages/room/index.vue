  ...
  <div>
    <v-card>
      <v-card-title class="justify-center">
        <v-row>
          <v-col cols="10"> Rooms List </v-col>
          <v-col cols="2">
            <v-btn
              @click="addDataModel()"
              color="primary"
            ...
            <table class="table table-bordered">
              <thead class="text-center">
                <tr>
                  ...
                  <th>
                    <a href="#" @click.prevent="change_sort('capacity')"
                      >Capacity</a
                    >
                    <span
                      v-if="
                        sort_direction == 'desc' && sort_field == 'capacity'
                      "
                      >&uarr;</span
                    >
                    <span
                      v-if="sort_direction == 'asc' && sort_field == 'capacity'"
                      >&darr;</span
                    >
                  </th>
                  <th>
                    <a href="#" @click.prevent="change_sort('projector')"
                      >Projector</a
                    >
                    <span
                      v-if="
                        sort_direction == 'desc' && sort_field == 'projector'
                      "
                      >&uarr;</span
                    >
                    <span
                      v-if="
                        sort_direction == 'asc' && sort_field == 'projector'
                      "
                      >&darr;</span
                    >
                  </th>
              ...
              <tbody>
                <tr v-for="singleData in allData.data" :key="singleData.id">
                  ...
                  <td>
                    <span v-if="singleData.projector == 1">Yes</span
                    ><span v-else>No</span>
                  </td>
    ...
    <v-dialog v-model="dataModalDialog" max-width="700px">
      <v-card>
        <v-card-title class="justify-center">
          <v-row>
            <v-col cols="10"> Add New Room </v-col>
            <v-col cols="2">
              <v-btn
              ...
              <v-row align-content="center">
                ...
                <v-col cols="12" lg="4">
                  <v-radio-group
                    ...
                    :rules="roomRulesFeature"
                    required
                    label="Projector Faciilty"
                    row
                  >
                    <v-radio
                      v-for="n in activeOptions"
                      :key="n.value"
                      :label="n.text"
                      :value="n.value"
                    ></v-radio>
...
export default {
  data() {
    return {
      ...
      roomRulesFeature: [(v) => v == 0 || v == 1 || "This field is required!"],
