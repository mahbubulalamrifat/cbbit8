    ...
    <div class="card">
      <div class="card-header">
        ...
        <div>
          ...
          <a
            href="/api/mobileapp/user_access?id=xxxx.yyy&module=xxx"
            target="_blank"
          >
            {{ baseUrl + "/api/mobileapp/version?id=xxxx.yyy&module=xxx" }}</a
          >
        </div>
      </div>
                ...
                <tr v-for="singleData in allData.data" :key="singleData.id">
                  ...
                  <td>
                    <span v-if="singleData.mobile_app_roles.length">
                      <span
                        v-for="(item, index) in singleData.mobile_app_roles"
                        :key="index"
                      >
