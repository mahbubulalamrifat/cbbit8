  ...
  <div>
    <v-card>
      <v-card-title class="justify-center">
        <v-row>
          <v-col cols="10"> Rooms Table </v-col>
          <v-col cols="2">
            <v-btn
              @click="addDataModel()"
              color="primary"
            ...
            <thead class="text-center">
              <tr>
                ...
                <th>
                  ...
                  >
                  <span
                    v-if="sort_direction == 'desc' && sort_field == 'capacity'"
                    >&uarr;</span
                  >
                  <span
                ...
                <th>
                  ...
                  >
                  <span
                    v-if="sort_direction == 'desc' && sort_field == 'projector'"
                    >&uarr;</span
                  >
                  <span
                    v-if="sort_direction == 'asc' && sort_field == 'projector'"
                    >&darr;</span
                  >
                </th>
                <th>Action</th>
