  ...
  <div>
    <v-card>
      <v-card-title class="justify-center">
        <v-row>
          <v-col cols="10"> All Sub Ip List </v-col>
          <v-col cols="2">
            <v-btn
              @click="addDataModel()"
              color="primary"
      ...
      <v-card-text>
        <div v-if="allData.data">
          <v-row>
            ...
            <v-col cols="6" lg="2">
              <v-btn @click="pingAll()" color="info" small class="float-right">
              ...
              <v-row>
                ...
                <v-col cols="12">
                  <div
                    ...
                    v-html="form.errors.get('group_name')"
                  />
                  <v-select
...
export default {
  ...
  methods: {
    ...
    getAllGroupName() {
      axios
        .get(this.currentUrl + "/group_name")
        .then((response) => {
