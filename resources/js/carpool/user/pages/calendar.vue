  ...
  <div>
    ...
    <v-dialog persistent v-model="eventDetailsModal" max-width="800px">
      <v-card>
        <v-card-title class="justify-center">
          <v-row>
            <v-col cols="10"> Booked Details </v-col>
            <v-col cols="2">
              <v-btn
                @click="eventDetailsModal = false"
                color="red lighten-1"
                small
                class="float-right"
              >
          ...
          <table class="table">
            ...
            <tr>
              ...
              <td v-if="clickCurrentEvetData.extendedProps">
                {{ clickCurrentEvetData.extendedProps.destination }}
              </td>
            </tr>
            <tr>
              <th>Purpose :</th>
              <td v-if="clickCurrentEvetData.extendedProps">
                {{ clickCurrentEvetData.extendedProps.purpose }}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td v-if="clickCurrentEvetData.extendedProps">
                {{
                  clickCurrentEvetData.extendedProps.created_at
                    | moment("dddd, MMMM Do YYYY, h:mm:ss a")
                }}
              </td>
            </tr>
            <tr>
              ...
              <td>
                <div class="row">
                  <div class="col-3">
                    <v-avatar size="50">
                      <v-img v-if="clickCurrentEvetData.extendedProps"
                        ><img
                          :src="
                            '/images/users/small/' +
                            clickCurrentEvetData.extendedProps.bookby.image
                          "
                          alt="image"
                        />
                      </v-img>
                  ...
                  <div class="col-9">
                    <span v-if="clickCurrentEvetData.extendedProps">
                      <b>Name: </b
                      >{{ clickCurrentEvetData.extendedProps.bookby.name }}
                      <br />
                      <b>Department: </b
                      >{{
                        clickCurrentEvetData.extendedProps.bookby.department
                      }}
                      <br />
                      <b>Contact: </b>
                      <span
                        v-if="
                          clickCurrentEvetData.extendedProps.bookby
                            .office_contact
                        "
                      >
                        <a
                          v-if="clickCurrentEvetData.extendedProps"
                          :href="
                            'tel:' +
                            clickCurrentEvetData.extendedProps.bookby
                              .office_contact
                  ...
                  <v-row>
                    <v-col cols="12" lg="3">
                      <v-avatar size="60">
                        <v-img v-if="clickCurrentEvetData.extendedProps"
                          ><img
                            :src="
                              '/images/carpool/driver/small/' +
                              clickCurrentEvetData.extendedProps.driver.image
                            "
                            alt="image"
                          />
                        </v-img>
                    ...
                    <v-col cols="12" lg="9">
                      <div>
                        <b>Car: </b>
                        <span v-if="clickCurrentEvetData.extendedProps"
                          >{{ clickCurrentEvetData.extendedProps.car.number }}
                        </span>
                        <span v-else class="error--text">N/A</span>
                      </div>
                      ...
                      <div>
                        <b>Driver: </b>
                        <span v-if="clickCurrentEvetData.extendedProps">{{
                          clickCurrentEvetData.extendedProps.driver.name
                        }}</span>
                        <span v-else class="error--text">N/A</span>
                      </div>
                      <div>
                        ...
                        ><a
                          ...
                          :href="
                            'tel:' +
                            clickCurrentEvetData.extendedProps.driver.contact
                          "
                          >{{
                            clickCurrentEvetData.extendedProps.driver.contact
                          }}</a
                  ...
                  <div class="d-flex justify-content-between flex-wrap">
                    <div>
                      <div>
                        ...
                        <span
                          v-if="
                            clickCurrentEvetData.extendedProps.start_mileage
                          "
                          >{{
                            clickCurrentEvetData.extendedProps.start_mileage
                          }}
                        ...
                        <span
                          v-if="clickCurrentEvetData.extendedProps.end_mileage"
                        >
                          --
                          {{ clickCurrentEvetData.extendedProps.end_mileage }}
                        </span>
                      ...
                      <div>
                        ...
                        ><span
                          v-if="
                            clickCurrentEvetData.extendedProps.cost !== null
                          "
                          >{{ clickCurrentEvetData.extendedProps.cost }}</span
                        >
                        <span v-else class="error--text">N/A</span>
                      </div>
                      ...
                      <div>
                        ...
                        ><span
                          v-if="
                            clickCurrentEvetData.extendedProps.driver_rating
                          "
                          >{{
                            clickCurrentEvetData.extendedProps.driver_rating
                          }}</span
                    ...
                    <div>
                      <div>
                        <b>Gasoline: </b
                        ><span
                          v-if="clickCurrentEvetData.extendedProps.gas !== null"
                          >{{ clickCurrentEvetData.extendedProps.gas }}</span
                        >
                        <span v-else class="error--text">N/A</span>
                      </div>
                      ...
                      <div>
                        ...
                        ><span
                          v-if="
                            clickCurrentEvetData.extendedProps.octane !== null
                          "
                          >{{ clickCurrentEvetData.extendedProps.octane }}</span
                        >
                        <span v-else class="error--text">N/A</span>
                      </div>
                      ...
                      <div>
                        ...
                        ><span
                          v-if="
                            clickCurrentEvetData.extendedProps.toll !== null
                          "
                          >{{ clickCurrentEvetData.extendedProps.toll }}</span
                        >
                        <span v-else class="error--text">N/A</span>
                      </div>
                    </div>
    ...
    <v-dialog persistent v-model="eventDataStoreModal" max-width="700px">
      <v-card>
        <v-card-title class="justify-center">
          <v-row>
            <v-col cols="10"> Conform Booking </v-col>
            <v-col cols="2">
              <v-btn
                @click="(eventDataStoreModal = false), resetForm()"
                color="red lighten-1"
                small
                class="float-right"
              >
        ...
        <v-card-text>
          <div
            v-if="currentSelectedCar"
            class="bg-info text-center rounded mb-2"
          >
            Selected Car: <b>{{ currentSelectedCar.name }}</b
            >, Capacity:
              ...
              <v-row>
                <v-col cols="12">
                  <div
                    ...
                    v-if="form.errors.has('destination')"
    ...
    <v-dialog persistent v-model="carStatusShow">
      <v-card>
        ...
        <v-card-title class="justify-center">
          <v-row>
            <v-col cols="10"> Car Booking </v-col>
            <v-col cols="2">
              <v-btn
                @click="carStatusShow = false"
        ...
        <v-card-text>
          <!-- All Free Cars -->
          <div
            class="teal--text pa-4 text-center font-weight-black text-overline"
          >
                ...
                <v-card dark :img="imagePathSm + item.image">
                  <div class="d-sm-flex justify-space-between">
                    <v-card-text>
                      <div class="card_text_bg py-2 pl-2">
                        <div v-if="item.driver" class="mb-2">
                          <div>
                            Driver Name: <b>{{ item.driver.name }}</b>
                          </div>
                          <div>
                            Driver Number:
                            <b
                              ><a :href="'tel:' + item.driver.contact"
                                >{{ item.driver.contact }}
                              </a></b
                            >
                          </div>
                    ...
                    <div class="ma-3">
                      <v-img
                        v-if="item.driver"
                        :src="imagePathSmDriver + item.driver.image"
                        alt="IMG"
                        class="size_avatar mx-auto"
                      ></v-img>
                    </div>
                  </div>
                  <v-card-actions>
                    <v-btn
                      @click="bookingModal(item)"
                  ...
                  <div class="d-sm-flex flex-no-wrap justify-space-between">
                    <v-card-text>
                      <div class="card_text_bg py-2 pl-2">
                        ...
                        <div v-if="item.car">
                          Car: {{ item.car.name }} || {{ item.car.number }}
                        </div>
                        <div>
                          Start:
                          {{ item.start | moment("MMM Do YYYY, h:mm a") }}
                        </div>
                        <div>
                          End: {{ item.end | moment("MMM Do YYYY, h:mm a") }}
                        </div>
                        <div>
                          Destination: {{ item.destination }}
                          <span v-if="item.bookby">
                            --By ( {{ item.bookby.name }} )</span
                          >
                        </div>
...
export default {
  ...
  data: function () {
    return {
      ...
      remRules: [
        (v) =>
          (v || "").length <= 500 || "Purpose must be 500 characters or less",
  ...
  methods: {
    ...
    leaveVal(val) {
      ...
      return (
        levType +
        ": " +
        this.$moment(val.start).format("MMM Do YYYY, h:mm a") +
        " -- " +
        this.$moment(val.end).format("MMM Do YYYY, h:mm a")
      );
    },
    ...
    async getDataAsync() {
      try {
        const response = await axios.get(
          this.currentUrl + "/data?sort_by_car=" + this.sort_by_car
        );
    ...
    getDastination() {
      axios
        .get("/carpool/booked/destinations")
        .then((response) => {
          // console.log(response.data)
    ...
    onEventRender: function (args) {
      ...
      let contentStr =
        this.$moment(args.event.start).format("MMM Do, h:mm:ss a") +
        " - " +
        this.$moment(args.event.end).format("MMM Do, h:mm:ss a");
    ...
    handleEventClick(clickInfo) {
      ...
      console.log(
        "clickInfo",
        this.clickCurrentEvetData.extendedProps,
        this.clickCurrentEvetData.extendedProps.car
      );
    },
  ...
  mounted() {
    document.getElementsByClassName("fc-button")[1].style.padding =
      "0 5px 7px 5px";
    document.getElementsByClassName("fc-button")[0].style.padding =
      "0 5px 7px 5px";
