<template>
    <div>
        ...
        <div>
            <v-select class="mx-5" v-if="carData.length" :items="carData" label="All Cars Data" v-model="sort_by_car"></v-select>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td v-if="clickCurrentEvetData.extendedProps">
                                {{ clickCurrentEvetData.extendedProps.destination }}</td>
                        </tr>
                        <tr>
                            <th>Purpose : </th>
                            <td v-if="clickCurrentEvetData.extendedProps">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <span v-if="clickCurrentEvetData.extendedProps">
                                            ...
                                            <b>Department:
                                            </b>{{ clickCurrentEvetData.extendedProps.bookby.department }} <br>
                                            <b>Contact: </b>
                                            <span v-if="clickCurrentEvetData.extendedProps.bookby.office_contact">
                                                <a v-if="clickCurrentEvetData.extendedProps"
                                                    :href="'tel:'+clickCurrentEvetData.extendedProps.bookby.office_contact">{{clickCurrentEvetData.extendedProps.bookby.office_contact}}</a>
                                                <span v-else class="error--text">N/A</span>
                                            </span>
                                            <span v-else>
                                                <a v-if="clickCurrentEvetData.extendedProps"
                                                    :href="'tel:'+clickCurrentEvetData.extendedProps.bookby.personal_contact">{{clickCurrentEvetData.extendedProps.bookby.personal_contact}}</a>
                                                <span v-else class="error--text">N/A</span>
                                            </span>
                                        </span>
                                    </div>
                                ...
                                <v-col cols="12" md="6">
                                    ...
                                    <v-menu ref="menu3" v-model="menu3" :close-on-content-click="false"
                                        ...
                                        <v-time-picker v-if="menu3" v-model="form.start_time" full-width
                                            @click:minute="$refs.menu3.save(time)" ampm-in-title :min="minTime1"
                                            :max="maxTime1"></v-time-picker>
                                    </v-menu>
                                </v-col>
                                ...
                                <v-col cols="12" md="6">
                                    ...
                                    <v-menu ref="menu4" v-model="menu4" :close-on-content-click="false"
                                        ...
                                        <v-time-picker v-if="menu4" v-model="form.end_time" full-width
                                            @click:minute="$refs.menu4.save(time)" ampm-in-title :min="minTime2"
                                            :max="maxTime2"></v-time-picker>
                                    </v-menu>
                                </v-col>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async getDataAsync() {
                try {
                    const response = await axios.get(this.currentUrl + '/data?sort_by_car=' + this.sort_by_car);
            ...
            onEventRender: function (args) {
                ...
                let contentStr = this.$moment(args.event.start).format("MMM Do, h:mm:ss a") + " - " + this.$moment(
                    args.event.end).format("MMM Do, h:mm:ss a");
        ...
        mounted() {
            document.getElementsByClassName('fc-button')[1].style.padding = '0 5px 7px 5px';
            document.getElementsByClassName('fc-button')[0].style.padding = '0 5px 7px 5px';
